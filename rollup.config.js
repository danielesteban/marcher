...
const token = production ? (
  'Aty34xCzR5RY183Zh4XWsPLLrrDNIywP2KPIk1adAIRGaDBMWFORLMX2ihRyk3MWQNBjEIE7LKwvtFJongqDogMAAABTeyJvcmlnaW4iOiJodHRwczovL21hcmNoZXIuZ2F0dW5lcy5jb206NDQzIiwiZmVhdHVyZSI6IldlYkdQVSIsImV4cGlyeSI6MTY3NTIwOTU5OX0='
) : (
  ...
  plugins: [
    ...
    ...(production ? [
      terser({ format: { comments: false } }),
      {
        name: 'cname',
        writeBundle() {
          fs.writeFileSync(path.join(outputPath, 'CNAME'), 'marcher.gatunes.com');
        },
      },
    ] : [
      serve({
